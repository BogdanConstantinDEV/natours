...
var getMap = function getMap(locations) {
  ...
  locations.forEach(function (loc) {
    ...
    markup.className = 'marker'; // add morker
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("".concat(loc.day, ". ").concat(loc.description)).addTo(map); // set map bounds coordinates
...
var showAlert = function showAlert(type, message) {
  hideAlert();
  var el = "<div class='alert alert--".concat(type, "'>").concat(message, "</div>");
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'There was and error when logging out');
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Signed up successfuly.  WELCOME');
              window.setTimeout(function () {
                return location.assign('/');
              }, 2000);
            }
          ...
          case 7:
            _context.prev = 7;
            _context.t0 = _context["catch"](0);
            (0, _alerts.showAlert)('error', _context.t0.responds.data.message);
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return axios({
              method: 'PATCH',
              url: "http://127.0.0.1:3000/api/v1/users/".concat(type === 'password' ? 'update-my-password' : 'update-me'),
              data: data
            });
...
var signupForm = document.querySelector('.form__singup');
var logoutButton = document.querySelector('.nav__el--logout');
var updateUserDataForm = document.querySelector('.form.form-user-data');
var updateUserPasswordForm = document.querySelector('.form-user-password'); // DECLARATIONS
// mapbox
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              oldPassword = updateUserPasswordForm.querySelector('#password-current').value;
              newPassword = updateUserPasswordForm.querySelector('#password').value;
              newPasswordConfirm = updateUserPasswordForm.querySelector('#password-confirm').value;
              _context.next = 7;
